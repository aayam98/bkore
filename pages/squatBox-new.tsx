...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const proProduct = await getProduct('mx1182xl-squat-box-pro-portable-belt-squat-station')
    const productStrapi = await getStrapiProduct('squat-box-mx1182');
    const proProductStrapi = await getStrapiProduct('mx1182xl-squat-box-pro-portable-belt-squat-station');
    ...
    const setupFeeProProduct = proProduct != undefined && proProduct!.setupProducts && (await getProduct(product!.setupProducts?.value as string));
...
export default function SquatBoxNew({
    ...
    const [slider1, setSlider1] = useState<any>([
        ...
        },
        {
            id: '3',
            title: '',
            description: 'Optimized Performancefor Every Setting Weather at home, the gym, or outdoors.',
    ...
    const [faqs, setFaqs] = useState<FAQStrapi[]>([
        {
            attributes: {
                ...
                question:
                    'What exercises can I perform with the Squat Box Original and Pro?',
                answer:
        ...
        },
        {
            attributes: {
                ...
                question:
                    'What is the maximum weight I can lift with each model?',
                answer:
        ...
        },
        {
            attributes: {
                ...
                question:
                    'How easy is the Squat Box to store?',
                answer:
        ...
        },
        {
            attributes: {
                ...
                question:
                    'How quickly will my Squat Box ship?',
                answer:
    ...
    const squatBoxData = [
        {
            icon: <img src='https://uxwing.com/wp-content/themes/uxwing/download/e-commerce-currency-shopping/flame-icon.png' alt='flames' width="24" height="24" />,
            ...
            icon: <img src='https://www.svgrepo.com/show/405667/flexed-biceps.svg' alt='strength' width="24" height="24" />,
            ...
            data: [
                ...
                },
                {
                    ...
                    description: 'Bicep curls, triceps overhead extensions, and lateral raises'
                }
            ]
        }, {
            icon: <img src='https://www.svgrepo.com/show/178156/flash-technology.svg' alt='functional' width="24" height="24" />,
            ...
            data: [
                ...
                },
                {
                    ...
                    description: 'The stable platform can also be used for bodyweight exercises like step-ups and jump squats (without added resistance)'
                }
            ]
        }
    ]
                ...
                <main>
                    <div className="w-full h-full">
                        <div className='relative w-full h-auto max-w-9xl mx-auto'>
                            <img
                                src='https://cdn.shopify.com/s/files/1/0609/8898/1468/files/gempages_543095999581652214-3a7859c7-a180-486c-bd2a-cf0d9a621907.png'
                                alt="banner"
                                className='w-full h-full object-cover'
                            />
                            <div className="absolute lg:top-0 lg:left-0 top-2 left-1 w-full h-full">
                                <div className='flex flex-row w-full gap-x-10'>
                                    <div className='flex w-full bg-red-bc2026'>
                                        <a
                                            onClick={() => scrollToSection(originalRef)}
                                            className="absolute cursor-pointer transition-colors z-50 w-1/2 h-8 lg:h-40 lg:w-3/6 lg:top-2/3 top-36 -left-6 lg:-left-20 rounded-xl hover:bg-white/30"
                                        />
                                    </div>
                                    <div className='flex w-full bg-bgImage'>
                                        <a
                                            onClick={() => scrollToSection(proRef)}
                                            className="absolute cursor-pointer transition-colors z-50 w-1/2 h-8 lg:h-40 lg:w-3/6 lg:top-2/3 top-36 right-0 lg:right-0 rounded-xl hover:bg-white/30"
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-gray-200  lg:pb-12">
                        <div className='lg:py-12 lg:px-0 px-10 py-6'>
                            <div className="max-w-8xl mx-auto px-2 flex flex-col justify-center text-center">
                                <h4 className="text-black md:text-3xl text-xl font-montserrat font-semibold capitalize leading-tight lg:pb-10 pb-5">
                                    Squat Box Core Features
                                </h4>
                                <div className='w-full flex justify-center'>
                                    <div className="max-w-7xl grid lg:grid-cols-2 grid-cols-1 gap-x-40 gap-y-12">
                                        <div className="">
                                            <a
                                                href="#"
                                                className=""
                                            >
                                                ...
                                                />
                                                <div className="">
                                                    <h5 className="text-black lg:text-xl text-lg font-montserrat capitalize font-semibold">
                    ...
                    <div className="py-14  bg-gray-300" ref={targetRef}>
                        <div className="max-w-8xl m-auto px-12">
                            ...
                            <h4 className="text-black md:text-3xl text-xl text-center font-montserrat font-semibold capitalize leading-tight lg:pb-10 pb-5">
                                    Squat Box Pro Additional features
                                </h4>
                            </div>
                            <div className={`grid lg:grid-cols-${subFeatureData.length}  grid-cols-1 gap-3`}>
                                {subFeatureData &&
                                    subFeatureData.map((subFeature, index) => {
                                        const title = subFeature.title;
                                        const images = subFeature.images.data.map((item) => item.attributes.url);
                                        return (
                                            <div className="text-left flex flex-col gap-2" key={index}>
                                                ...
                                                <h4 className="text-black text-md text-left font-montserrat font-semibold leading-tight">
                                                    {title}
                                                </h4>
                                            </div>
                                        );
                    ...
                    <div className="bg-black md:px-0 px-4">
                                ...
                                <ul>
                                    <li className="flex items-center gap-x-2">
                                        ...
                                        <Image
                                            ...
                                            objectFit="contain"
                                        ></Image>
                                        Detachable weight horns holds up to 270lbs (Pro Only).
                                    </li>
                                    <li className="flex items-center gap-x-2">
                                        {' '}
                                        <Image
                                            ...
                                            objectFit="contain"
                                        ></Image>
                                        Stabilizing handle attachment (Pro Only).
                                    </li>
                                    <li className="flex items-center gap-x-2">
                                        {' '}
                                        <Image
                                            ...
                                            objectFit="contain"
                                        ></Image>
                                        Straight bar and cable pulley extensions (included in Pro)
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className='bg-white py-8 flex justify-center text-center'>
                        <div className='w-full max-w-7xl mx-auto'>
                            <div className='max-w-5xl mx-auto'>
                                <h4 className='uppercase text-black text-3xl font-montserrat font-semibold textshadow'>
                                    squat box original or pro? see the key differences
                                </h4>
                                <h5 className='text-lg text-gray-500 leading-tight font-montserrat'>
                                    Optimized Performance for Every Setting Whether at home, the gym, or outdoors,
                                    the Squat Box adapts effortlessly to your environment. Connect it to a cable
                                    system or utilize resistance bands for a comprehensive workout tailored to your needs.
                                </h5>
                            </div>
                            ...
                            <div className='py-8 md:hidden max-w-5xl mx-auto'>
                                <ImageComparisonSlider
                            ...
                            <div className='flex gap-8 max-w-5xl mx-auto'>
                                <button className='uppercase bg-black-1c2023 hover:bg-red-hover font-montserrat text-white md:text-lg text-xs md:p-4 p-2 w-full rounded-sm' onClick={() => scrollToSection(originalRef)}>
                                    take me to the original squat box
                                </button>
                                <button className='uppercase bg-black-1c2023 hover:bg-red-hover font-montserrat text-white md:text-lg text-xs md:p-4 p-2 w-full rounded-sm' onClick={() => scrollToSection(proRef)}>
                    ...
                    <div className='flex flex-col'>
                        <div className='flex mx-auto bg-black lg:py-8 py-4 md:px-0 px-4 w-full'>
                            <h4 className='uppercase text-white text-center w-full lg:text-2xl text-lg font-montserrat font-semibold textshadow'>
                        ...
                        <div className=' bg-gray-200'>
                            <div className="py-6 max-w-8xl mx-auto grid lg:grid-cols-2 grid-cols-1">
                                    ...
                                    <div className="grid lg:grid-cols-2 lg:gap-14 gap-4 p-8">
                                        <div className="m-auto text-center space-y-1">
                                            ...
                                            <h6 className="text-gray-700 text-base font-montserrat pb-5 lg:h-24 h-auto ">
                                                Traditional squats can strain the spine, but <strong>belt squats shift the load to your hips</strong>, allowing you to train your legs intensely <strong>without compressing your lower back-</strong>ideal for those with back issues or injuries.
                                            </h6>
                                        </div>
                                        <div className="m-auto text-center space-y-1">
                                            <Image
                                            ...
                                            <h6 className="text-gray-700 text-base font-montserrat pb-5 lg:h-24 h-auto ">
                                                Compatible with <strong>selectorized weight stacks, plate, loading, and resistance bands,</strong> allowing you to adjust intensity and customize your workouts to match your fitness level.
                                            </h6>
                                        </div>
                                        <div className="m-auto text-center space-y-1">
                                            <Image
                                            ...
                                            <h6 className="text-gray-700 text-base font-montserrat pb-5 lg:h-24 h-auto ">
                                                Belt squats <strong>target the quads, glutes, hamstrings, and calves</strong> with the same intensity as barbell squats - helping you <strong>build power, endurance, and stability</strong> without added spinal stress.
                                            </h6>
                                        </div>
                                        <div className="m-auto text-center space-y-1">
                                            <Image
                                            ...
                                            <h6 className="text-gray-700 text-base font-montserrat pb-5 lg:h-24 h-auto ">
                                                Unlike full-size belt squat machines, the <strong>Squat Box Original & Pro</strong> provide a <strong>compact, portable solution</strong> that fits in home gyms, garage setups, or professional training spaces <strong>without taking up extra room.</strong>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                <div className="w-full">
                                    <Image
                                        src="https://cdn.shopify.com/s/files/1/0609/8898/1468/files/gempages_543095999581652214-a3e97a99-7d19-4c03-97e6-0dafd2a961aa.jpg"
                    ...
                    <div className='max-w-8xl mx-auto py-8'>
                        <div className="max-w-6xl mx-auto md:px-0 px-4">
                            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-8 justify-between">
                                <div className=''>
                                    <h4 className="uppercase text-black text-3xl font-montserrat font-semibold textshadow md:mb-4 mb-6">
                                        EXERCISE VERSATILITY – TRAIN YOUR ENTIRE BODY WITH THE SQUAT BOX
                                    </h4>
                                    <p className="text-gray-600 lg:mb-6 mb-8 font-montserrat">
                                        The <strong>Squat Box Original & Pro</strong> go beyond belt squats, offering a{" "}
                                        <strong>full-body training experience </strong> with multiple exercise variations.
                                        Whether you're focusing on <strong>strength, endurance, or injury recovery</strong>,
                                        these platforms provide a <strong>safe and effective way</strong> to load resistance
                            ...
                            <div className='flex justify-center'>
                                <h5 className='max-w-5xl text-gray-600 md:py-8 py-10 font-montserrat text-center'>
                                    With the <strong> Squat Box Original & Pro,</strong> you’re not limited to squats—you’re unlocking a <strong> versatile, total-body workout station</strong> in a <strong> compact, space-saving design</strong>.
                                </h5>
                            </div>
                        </div>
                    </div>
                    <div className='' ref={originalRef}>
                        <div className='py-4 bg-red-bc2026'>
                            <h4 className='uppercase text-white text-center md:text-3xl text-xl font-montserrat font-semibold textshadow'>
                                get your original squat box here
                            </h4>
                        </div>
                                ...
                                <div className="col-span-1">
                                    <SingleProduct
                                        ...
                                        product={{
                                            ...
                                            quantity: proProduct.variants.edges[0].node.quantityAvailable,
                                        }}
                                        ...
                                        dimension={
                                            proProductStrapi.attributes.specification.length > 0
                                                ? proProductStrapi.attributes.specification[0].dimensions
                                                : ''
                                        }
                    ...
                    <div className="py-14 bg-black">
                        <div className="max-w-8xl m-auto px-12">
                            <div className="text-center">
                                ...
                                <h2 className="uppercase text-white lg:text-5xl text-3xl font-montserrat font-semibold leading-tight pb-10">
