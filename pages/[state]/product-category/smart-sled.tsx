            ...
            if (widthSize !== undefined && widthSize >= 800) {
              return (
                <div className="pt-10 pb-12 max-w-7xl m-auto flex flex-wrap">
                  ...
                  <div className="flex justify-end lg:justify-end lg:w-2/4 py-8 lg:py-0">
                    {/* <Link
                      href={'${routes.products.path}?category=Packages' || '#'}
                      passHref
                    >
                      <button
                        className={`w-52 h-12 mb-2 bg-transparent text-black-373933 border border-black-373933 hover:text-red-bc2026 hover:border-red-bc2026 rounded-lg font-bebas`}
                        style={{ letterSpacing: '1px' }}
                      >
                        <span className="font-bold">SEE ALL PACKAGEss</span>
                      </button>
                    </Link> */}
                  </div>
