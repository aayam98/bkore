...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const params: string[] | undefined = context.query.products
    ?.toString()
    .split(',');
      ...
      <main className="w-full">
        <section className="pb-36">
          ...
          <div className="lg:flex text-center font-bebas text-4xl lg:text-5xl font-bold italic pt-28 px-16 max-w-8xl m-auto">
            <h5 className="text-black-373933 tracking-wider">
                        ...
                        <tr className="border-b">
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              ...
                              >
                                {ele.attributes.specification[0].dimensions}
                              </th>
                            );
                          })}
                        </tr>
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].weight}
                              </th>
                            );
                          })}
                        </tr>
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].footprint}
                              </th>
                            );
                          })}
                        </tr>
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].frame}
                              </th>
                            );
                          })}
                        </tr>
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].frameColor}
                              </th>
                            );
                          })}
                        </tr>
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].weightStack}
                              </th>
                            );
                          })}
                        </tr>
                        <tr className="border-b">
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              ...
                              >
                                {
                                  ele.attributes.specification[0]
                                    .ofAdjustableHeightPositions
                                }
                              </th>
                            );
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].ofWeightPegs}
                              </th>
                            );
                          })}
                        </tr>
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].barStorage}
                              </th>
                            );
                          })}
                        </tr>
                          ...
                          {compareProducts.map((ele, i) => {
                            return (
                              <th
                                ...
                                className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r"
                              >
                                {ele.attributes.specification[0].assemblyTime}
                              </th>
                            );
                          })}
                        </tr>
