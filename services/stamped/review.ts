...
export const getReviewsOfProduct = async (
  ...
  productId && params.append('productId', productId);
  params.append('minRating', '4'); // Without this it only returns 5 stars
...
export const createReview = async ({
  ...
  formdata.append('productSKU', "Product's Sku" + productId);
  formdata.append(
    'productImageUrl',
