...
export default function PayTomorrowFinance() {
  return (
    <>
      <div>
        <main className="w-full">
          {/* Main banner with solid image */}
          <div className="flex h-96   pt-72 pb-10  items-center justify-center bg-paytomorrow">
          ...
          {/* <div className="w-full m-auto pt-36 pb-20">
            <div className="grid grid-cols-3 max-w-6xl gap-x-10 p-16 rounded-3xl m-auto bg-paytomorrow relative">
              <div className="col-span-2">
                <h5 className="text-3xl tracking-wider font-bold font-bebas italic pb-1 text-white">
              ...
              <div className="z-30 flex flex-wrap right-0 -top-36 absolute">
                <img
                  src="/paytomorrow/mobile.png"
                  className="object-contain m-auto w-96"
                />
              </div>
            </div>
          </div> */}
