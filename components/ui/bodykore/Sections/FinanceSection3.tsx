                    ...
                    {options.map((o, i) => {
                        return (
                            <div className='w-1/3 lg:w-80 mx-28 lg:mx-0 py-8' key={i}>
                                <h5 className='font-bebas text-7xl font-bold italic text-center text-red-bc2026' style={{ letterSpacing: '1px' }}>{o.num}</h5>
                                <h5 className='font-bebas text-3xl font-semibold italic text-center mt-4' style={{ letterSpacing: '1px' }}>{o.title}</h5>
