                ...
                <div className="flex flex-wrap justify-center max-w-7xl m-auto">
                    <div className='md:pr-20 lg:pr-44'>
                        <div className="flex justify-center w-96 lg:justify-start">
                            <h3 className="text-white-f2f9fa text-5xl font-bebas font-bold italic">{title1}</h3>
                            <h3 className="text-red-bc2026 pl-2 text-5xl font-bebas font-bold italic">{title2}</h3>  
                        </div>
                        <p className="w-96 text-white-f2f9fa pt-6 text-md font-roboto leading-7 text-center lg:text-left pb-3">
                            {description}
                        </p>
                        <h3 className='text-red-bc2026 font-bebas text-lg text-center lg:text-left' style={{ letterSpacing: '1px' }}>{points}</h3>
                            ...
                            {discountRow1.map((d, i) => {
                                return (
                                    <div className='px-5' key={i}>
                                        <p className='text-white font-bebas text-4xl font-bold text-center italic'>{d.discount}</p>
