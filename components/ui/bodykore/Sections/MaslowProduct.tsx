...
interface WorkoutwithJamesMaslowProps {
  rating: number;
  numReviews: number;
  description?: string;
  shippingCost?: string;
...
const WorkoutwithJamesMaslow = ({
  ...
  return (
    <>
      {/* ---------------------Update part--------------------- */}
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 px-2 items-end justify-end">
        <div className=''>
        {/* >>>>>>>>>>>>>>>>>>>>>>>>price sections<<<<<<<<<<<<<<<<<<<< */}
        ...
        {multipleOptions && (
          <div className="w-full px-2 relative z-30 pt-5">
...
<div className='lg:pt-0 pt-10'>
        {/* >>>>>>>>>>>>>>>>>>>>>>>>Total with assembly<<<<<<<<<<<<<<<<<<<< */}
          ...
          <div className="grid lg:grid-cols-6 grid-cols-12 items-center gap-3">
              <p className="leading-none lg:col-span-1 col-span-3">
                Qty :
               
              </p>
              <input
                  className=" text-gray-700 h-12 px-4 leading-tight border border-gray-300 rounded-lg lg:col-span-5 col-span-9 my-2"
                  type={'number'}
                  min="1"
                  step="1"
                  onInput={(event: any) => {
...
export default WorkoutwithJamesMaslow;