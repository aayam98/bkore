                    ...
                    <div className="flex flex-wrap-reverse justify-center gap-32 lg:gap-36 max-w-7xl m-auto px-8">
                            ...
                            {options.map((o, i) => {
                                return (
                                    <div className='px-8' key={i}>
                                        <h5 className='text-white font-bebas text-4xl font-bold text-center italic'>{o.num}</h5>
                        ...
                        <div className='w-2/5 pt-10 lg:pt-0'>
                            <div className="flex justify-center lg:justify-start">
                                <h3 className="text-red-bc2026 text-5xl font-bebas font-bold italic">{title1}</h3> 
                                <h3 className="text-white-f2f9fa pl-2 text-5xl font-bebas font-bold italic">{title2}</h3>   
                            </div>
